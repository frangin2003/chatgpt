window.addEventListener("DOMContentLoaded", function () {
    ...
    const a = [["English (US)", "en-US"], ["English (UK)", "en-GB"], ["English (AU)", "en-AU"], ["普通话 (中国大陆)", "cmn-Hans-CN"], ["中文 (台灣)", "cmn-Hant-TW"], ["粵語 (香港)", "yue-Hant-HK"], ["Bahasa Indonesia", "id-ID"], ["Čeština", "cs-CZ"], ["Dansk", "da-DK"], ["Deutsch", "de-DE"], ["Español (ES)", "es-ES"], ["Español (MX)", "es-MX"], ["Français", "fr-FR"], ["Hrvatski", "hr_HR"], ["Íslenska", "is-IS"], ["Italiano", "it-IT"], ["Magyar", "hu-HU"], ["Nederlands", "nl-NL"], ["Norsk bokmål", "nb-NO"], ["Polski", "pl-PL"], ["Português (PT)", "pt-PT"], ["Português (BR)", "pt-BR"], ["Română", "ro-RO"], ["Slovenčina", "sk-SK"], ["Suomi", "fi-FI"], ["Svenska", "sv-SE"], ["Türkçe", "tr-TR"], ["日本語", "ja-JP"], ["한국어", "ko-KR"], ["Pусский", "ru-RU"]];
    let o = [];
    async function r() {
        if (o.length > 0)
            return o;
        ...
        return a.forEach((n => {
            e.some((e => i(e.lang, n[1]))) ? o.push(n) : t.warn(`${n[0]} not supported. Removed from selector.`)
        }
        )),
            o
    }
                        ...
                        return e.id = "sai-no-voices",
                            ...
                            void (e.onclick = () => {
                                ...
                                e += "No text-to-speech voices detected on your computer.\n\n",
                                    e += "Please see https://voice-control-faq.carrd.co/ on how to install voices.",
                                    alert("No text-to-speech voices detected on your computer.\n\nPlease see https://voice-control-faq.carrd.co/ on how to install voices.")
                            }
                            )
                    }
                    e.forEach((([e, n]) => {
    ...
    class d {
        ...
        observerCallback(e) {
            ...
            0 === n.length && (t.info("No text, reset"),
                this.reset());
        ...
        readAloud(e) {
            return new Promise(((n, s) => {
                ...
                const o = new SpeechSynthesisUtterance(a)
                    , r = this.synth.getVoices().reverse().find((e => i(e.lang, this.lang)));
                if (!r)
                    throw new Error(`unknown voice: ${r} lang: ${this.lang}`);
                o.volume = 1,
                    o.voice = r;
                ...
                let c;
                o.rate = d,
                    t.success(`Voice name: ${r.name}, lang: ${r.lang}, rate: ${d}: ${a}`);
                const h = () => {
                    const [e, n] = function (e, n, s, i, a, o) {
                        ...
                        return r > l ? (t.error(`No utter timeout ${l.toFixed(1)} - cancel.`),
                            ...
                            [0, 0]) : [l, r]
                    }(r.lang, d, this.lastUtter, this.lastTimeout, this.lastUtterCharCount, this.lastTimeSinceLastUtter);
                    this.lastTimeout = e,
        ...
        getText() {
            const e = document.querySelectorAll(".markdown")
                , n = e[e.length - 1]?.children ?? [];
            let t = "";
            for (const e of n)
                "PRE" !== e.nodeName && (t += e.textContent);
                ...
                this.recognition.onresult = e => {
                    ...
                    for (let t = e.resultIndex; t < e.results.length; ++t)
                        e.results[t].isFinal ? this.isRecording && (this.transcript += e.results[t][0].transcript,
                            s(this.transcript)) : n += e.results[t][0].transcript;
    ...
    class h {
        ...
        setupListeners() {
            ...
            if (!(e && n && s && i))
                return void t.warn("range slider missing");
            s.onclick = () => {
                this.settingsView.classList.add("sai-hide")
            }
                ,
                i.onclick = () => {
                    ...
                    e && "true" === e ? (window.localStorage.setItem('"sai-hidden"', "false"),
                        this.appIsHidden = !1,
                        i.innerText = "Hide Voice Control") : (window.localStorage.setItem('"sai-hidden"', "true"),
                            this.appIsHidden = !0,
            ...
            const a = t => {
                ...
                e.value = t,
                    window.localStorage.setItem("sai-voice-speed", t)
            }
                ;
            e.oninput = e => {
                const n = e.target;
    ...
    class g {
        ...
        keyUpHandler(e) {
            this.spaceIsDown && "Space" === e.code && (t.info("Space stop"),
                this.stopRecording())
        }
        speechHandlers() {
            this.spaceIsDown = !1,
    ...
    function x(e) {
        ...
        m && s && (t.info("Re-init app"),
            n && n.remove(),
            u = new g(!0),
            m = !1,
            document.addEventListener("keydown", w),
            document.addEventListener("keyup", b)),
            n && s || (t.warn("App removed"),
                n && n.remove(),
                u.readAloud.reset(),
    ...
    document.addEventListener("keydown", w),
        document.addEventListener("keyup", b);
    new MutationObserver(x).observe(document.body, {
        childList: !0,
        subtree: !0,
        characterData: !0
    }),
